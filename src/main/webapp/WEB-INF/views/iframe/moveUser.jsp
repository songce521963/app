...
<html>
	<head>
		...
		<link href="${pageContext.request.contextPath }/resources/css/iframe/moveUser.css" rel="stylesheet">
		<!--js-->
		...
		<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/iframe/moveUser.js"></script>
	</head>
<body>
<div>
