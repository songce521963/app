...
<html>
	<head>
		...
		<link href="${pageContext.request.contextPath }/resources/css/iframe/moveOrg.css" rel="stylesheet">
		<!--js-->
		...
		<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/iframe/moveOrg.js"></script>
	</head>
<body>
<div>
