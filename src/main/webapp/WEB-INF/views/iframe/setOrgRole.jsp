...
<html>
	<head>
		...
		<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/css/iframe/setOrgRole.css" >
		<!--js-->
		...
		<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/iframe/setOrgRole.js"></script>
	</head>
<body>
<div>
    <!-- 角色对应的资源 -->
