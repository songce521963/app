...
<head>
	<title>任务办理</title>
	<!--css-->
	<link href="${pageContext.request.contextPath }/resources/css/activiti/leave_task_form.css" rel="stylesheet">
	<!--js-->
	<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/activiti/leave_task_form.js"></script>
</head>
<body>
	<!-- 头部 -->
	<div id="alert"></div>
	<div class="header">
		...
		<ul class="breadcrumb">
			...
			<li><a href="${pageContext.request.contextPath }//activiti/task/show.html">任务管理</a> </li>
		...
		<table class="table table-bordered">
			...
			<tbody>
				...
				<tr>
					...
					<td colspan=3 class="col-md-4"><textarea disabled="disabled"  name="comments"
							class="validate[maxSize[20]] form-control" rows="3"
							placeholder="请输入请假详情">${leaveBill.comments}</textarea></td>
				</tr>
			</tbody>
		</table>
	</form>
	<form id="applyFrom" action="${pageContext.request.contextPath }/activiti/leaveBillAudit/approve.html" method="post"
		...
		<table class="table table-bordered">
			...
			<tbody>
				<tr>
					<td class="col-md-2">请假备注</td>
					<td class="col-md-10"><textarea name="comment"
							class="validate[maxSize[20]] form-control" rows="3"
							placeholder="请输入请假备注"></textarea></td>
				</tr>
				<tr>
					<td colspan=2 style="text-align: center;">
						<c:forEach var="list" items="${outComeList}">
							<button id="leaveSubmit" name="outcome" type="button" class="btn btn-primary submit"
								style="margin-right: 20px;">${list}</button>
						</c:forEach>
						<button id="leaveSubmit" type="submit" class="btn btn-primary"
							style="margin-right: 20px;">驳回</button>
					</td>
				</tr>
			</tbody>
		</table>
			...
			<table class="table table-bordered">
				...
				<tbody>
					<c:forEach var="list" items="${comments}">
						<tr>
							<td class="col-md-3"><fmt:formatDate value="${list.time}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
